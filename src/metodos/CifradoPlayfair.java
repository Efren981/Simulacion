...
public class CifradoPlayfair {
    ...
    /*public static void main(String[] args) {
		// TODO Auto-generated method stub
                CifradoPlayfair c=new CifradoPlayfair();
		...
		String cipher =	c.Cifrado_Playfair(mensaje,clave);
		String mensaje2 = c.Descifrado_Playfair(cipher,clave);
        ...
        public String imprimir(char[][]array){
            String cad="";
	...
	public String Descifrado_Playfair(String cipher,String clave){
	...
	public String Cifrado_Playfair(String mensaje,String clave){
...
public static int[] ObtenerPosicionCaracter(char caracter,char [][] matris){
	...
	public char [][] GenerarParejas(String mensaje){
