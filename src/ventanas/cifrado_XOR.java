...
import java.awt.*;
import metodos.CifradoXOR;
public class cifrado_XOR extends JFrame implements ActionListener{
    ...
    public cifrado_XOR() {
        ...
        lbl_tit = new JLabel("Cifrado XOR");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btn_cifrar1) {
            ...
            String acumulador2="";
            mensajeB = xor.TextoABinario(mensaje);
            claveB= xor.TextoABinario(clave);
            cad1="Mensaje: "+mensaje;
            resultado = xor.Cifrado_Descifrado_XOR(mensajeB,claveB);
            cad2=xor.Imprimir(resultado);
            texto.setText(cad1+"\nMensaje cifrado: "+cad2);
        ...
        if (e.getSource() == btn_decifrar1) {
            texto.setText(""); 
            try {
                String[] resultado2 = xor.Cifrado_Descifrado_XOR(resultado,claveB);
                texto.setText("mensaje encriptado: "+cad2+"\nMensaje real: "+xor.BinarioATexto(resultado2));
